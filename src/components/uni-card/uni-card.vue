<template>
  <view :class="{ 'uni-card--full': isFull === true || isFull === 'true',
   ...
   class="uni-card" @click="onClick">
    <view v-if="mode === 'style'" class="uni-card__thumbnailimage">
      <view class="uni-card__thumbnailimage-box">
        <image class="uni-card__thumbnailimage-image" :src="thumbnail"
        mode="aspectFill" />
      </view>
    ...
    <view v-if="mode === 'title'" class="uni-card__title">
      <view class="uni-card__title-header">
        <image class="uni-card__title-header-image" :src="thumbnail"
        mode="scaleToFill" />
      </view>
